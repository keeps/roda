...
echo "Creating RODA Database"
mysql -h RODADATA_MYSQL_HOST -P RODADATA_MYSQL_PORT -u $RODADATA_MYSQL_RODACORE_USER -p$RODADATA_MYSQL_RODACORE_PASSWD < $RODA_HOME/config/sql/create-roda-db.sql
