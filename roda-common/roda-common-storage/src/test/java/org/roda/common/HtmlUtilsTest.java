...
public class HtmlUtilsTest {
   ...
   * ModelServiceException, StorageActionException, IndexActionException { final
   * String aipId = UUID.randomUUID().toString(); final AIP aip =
   * model.createAIP(aipId, corporaService,
   * DefaultStoragePath.parse(CorporaConstants.SOURCE_AIP_CONTAINER,
   * CorporaConstants.SOURCE_AIP_ID)); SimpleRepresentationPreservationMetadata
   * srpm = index.retrieveSimpleRepresentationPreservationMetadata(aipId,
