...
public class RepresentationFile implements Serializable {
	...
	public RepresentationFile(String id, String originalName, long size,
			String accessURL, FileFormat fileFormat) {
	...
	public RepresentationFile(RepresentationFile representationFile) {
		this(representationFile.getId(), representationFile.getOriginalName(),
				representationFile.getSize(),
				representationFile.getAccessURL(), representationFile
						.getFileFormat());
	}
