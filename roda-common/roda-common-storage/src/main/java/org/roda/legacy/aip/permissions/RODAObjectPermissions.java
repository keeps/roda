...
public class RODAObjectPermissions implements Serializable {
	...
	public String toString() {
		return "RODAObjectPermissions(objectID=" + getObjectID()
	...
	public String[] getReadUsers() {
		return readUsers.toArray(new String[readUsers.size()]);
	}
	...
	public String[] getReadGroups() {
		return readGroups.toArray(new String[readGroups.size()]);
	}
	...
	public String[] getModifyUsers() {
		return modifyUsers.toArray(new String[modifyUsers.size()]);
	}
	...
	public String[] getModifyGroups() {
		return modifyGroups.toArray(new String[modifyGroups.size()]);
	}
	...
	public String[] getRemoveUsers() {
		return removeUsers.toArray(new String[removeUsers.size()]);
	}
	...
	public String[] getRemoveGroups() {
		return removeGroups.toArray(new String[removeGroups.size()]);
	}
	...
	public String[] getGrantUsers() {
		return grantUsers.toArray(new String[grantUsers.size()]);
	}
	...
	public String[] getGrantGroups() {
		return grantGroups.toArray(new String[grantGroups.size()]);
	}
