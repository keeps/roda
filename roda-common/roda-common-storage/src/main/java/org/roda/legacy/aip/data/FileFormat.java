...
public class FileFormat implements Serializable {
	...
	public FileFormat(FileFormat fileFormat) {
		this(fileFormat.getName(), fileFormat.getVersion(), fileFormat
				.getPuid(), fileFormat.getMimetype(), fileFormat
	...
	public boolean equals(Object obj) {
		if (obj instanceof FileFormat) {
			...
			if ((getFormatRegistryName() == null)
					&& (other.getFormatRegistryName() != null)) {
				return false;
			}
