package org.roda.legacy.sip.data;
...
public class SIPStateTransition implements Serializable {
	...
	public SIPStateTransition(SIPStateTransition sipStateTransition) {
		this(sipStateTransition.getSipID(), sipStateTransition.getFromState(),
				sipStateTransition.getToState(), sipStateTransition
						.getDatetime(), sipStateTransition.getTaskID(),
				sipStateTransition.isSuccess(), sipStateTransition
						.getDescription());
	}
	 ...
	 * @param description
	 */
	public SIPStateTransition(String sipID, String fromState, String toState,
			Date datetime, String taskID, boolean success, String description) {
	...
	public String toString() {
		return "SIPStateTransition (sipID=" + getSipID() + ", fromState="
				+ getFromState() + ", toState=" + getToState() + ", datetime="
				+ getDatetime() + ", taskID=" + getTaskID() + ", success="
				+ isSuccess() + ", description=" + getDescription() + ")";
	}
