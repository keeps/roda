 ...
 * @author Rui Castro
 */
public class Group extends RODAMember {
	...
	public Group(String name) {
		super(true, name, null, null, null, null, null);
	}
	...
	public Group(Group group) {
		super(group.isActive(), group.getName(), group.getFullName(), group
				.getGroups(), group.getAllGroups(), group.getDirectRoles(),
				group.getRoles());
	...
	public String[] getMemberUserNames() {
		return memberUserNames.toArray(new String[memberUserNames
				.size()]);
	}
	...
	public String[] getMemberGroupNames() {
		return memberGroupNames.toArray(new String[memberGroupNames
				.size()]);
	}
	 ...
	 */
	/*
	 * public String getMemberName(int index) { return
	 * memberUserNames.get(index); }
	 */
