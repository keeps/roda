...
public class FedoraStorageService implements StorageService {
  ...
  public Container getContainer(StoragePath storagePath) throws StorageServiceException {
    ...
    try {
      return FedoraConversionUtils.fedoraObjectToContainer(fedoraRepository.getObject(FedoraUtils
  ...
  private void addMetadataToResource(FedoraResource resource, Map<String, Set<String>> metadata) throws FedoraException {
    if (metadata != null) {
  ...
  public Class<? extends Entity> getEntity(StoragePath storagePath) throws StorageServiceException {
    if (storagePath.isFromAContainer()) {
      if (getContainer(storagePath) != null) {
        ...
        throw new StorageServiceException("There is no Container in the storage represented by \""
      ...
      try {
        ...
        throw new StorageServiceException("There is no Directory or Binary in the storage represented by \""
          + storagePath.asString() + "\"", StorageServiceException.INTERNAL_SERVER_ERROR, e);
      }
