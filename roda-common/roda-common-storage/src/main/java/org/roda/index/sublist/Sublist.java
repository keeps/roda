package org.roda.index.sublist;
...
public class Sublist implements Serializable {
	...
	public String toString() {
		return "Sublist(firstElementIndex=" + getFirstElementIndex()
				+ ", maximumElementCount=" + getMaximumElementCount() + ")";
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj != null && obj instanceof Sublist) {
			...
			equal = equal
					&& (getFirstElementIndex() == other.getFirstElementIndex());
			equal = equal
					&& (getMaximumElementCount() == other
