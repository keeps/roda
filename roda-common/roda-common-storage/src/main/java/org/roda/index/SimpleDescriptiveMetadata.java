...
public class SimpleDescriptiveMetadata {
	...
	public SimpleDescriptiveMetadata(String level, String title,
			String description, Date dateInitial, Date dateFinal,
			String parentId, long childrenCount,
			List<String> descriptiveMetadataFileIds) {
		super();
		this.level = level;
		this.title = title;
	 ...
	 */
	public void setDescriptiveMetadataFileIds(
			List<String> descriptiveMetadataFileIds) {
		this.descriptiveMetadataFileIds = descriptiveMetadataFileIds;
	}
