...
public class AIP {
	...
	private final List<String> descriptiveMetadataIds;
	private final List<String> representationIds;
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((descriptiveMetadataIds == null) ? 0
						: descriptiveMetadataIds.hashCode());
		result = prime * result + ((id == null) ? 0 : id.hashCode());
		result = prime * result
				+ ((parentId == null) ? 0 : parentId.hashCode());
		result = prime
				* result
				+ ((representationIds == null) ? 0 : representationIds
						.hashCode());
		return result;
	}
	...
	public String toString() {
		return "AIP [id=" + id + ", parentId=" + parentId + ", active="
				+ active + ", dateCreated=" + dateCreated + ", dateModified="
				+ dateModified + ", descriptiveMetadataIds="
				+ descriptiveMetadataIds + ", representationIds="
				+ representationIds + "]";
	}
