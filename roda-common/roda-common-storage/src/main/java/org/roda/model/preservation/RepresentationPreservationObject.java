 ...
 * @author Rui Castro
 */
public class RepresentationPreservationObject extends
		SimpleRepresentationPreservationMetadata {
	...
	/**
	 * The representation part files. This list can be <code>null</code> or
	 * empty.
	 */
	...
	/**
	 * The ID of the event that created this derivative representation. This
	 * field can be <code>null</code>, but if it's not <code>null</code>, than
	...
	public RepresentationPreservationObject(RepresentationPreservationObject rpo) {
		...
		setDerivedFromRepresentationObjectID(rpo
	 ...
	 * @param ID
	 */
	public RepresentationPreservationObject(String id, String label,
	...
	public String toString() {
		...
		return "RepresentationPreservationObject( " + super.toString()
				+ ", preservationLevel=" + getPreservationLevel()
				+ ", rootFile=" + getRootFile() + ", partFiles="
				+ partFilesCount + ", derivedFromRepresentationObjectID="
				+ getDerivedFromRepresentationObjectID()
				+ ", derivationEventID=" + getDerivationEventID()
				+ ", preservationEventIDs="
				+ Arrays.toString(getPreservationEventIDs()) + " )";
	 ...
	 */
	public void setRootFile(RepresentationFilePreservationObject rootFile)
			throws NullPointerException {
	 ...
	 */
	public void setDerivedFromRepresentationObjectID(
			String derivedFromRepresentationObjectID) {
