...
public class File {
	...
	public File(String id, String aipId, String representationId,
			boolean entryPoint, FileFormat fileFormat, StoragePath storagePath) {
		super();
		this.id = id;
		this.aipId = aipId;
	...
	public String toString() {
		return "File [id=" + id + ", aipId=" + aipId + ", representationId="
				+ representationId + ", entryPoint=" + entryPoint
				+ ", fileFormat=" + fileFormat + ", storagePath=" + storagePath
				+ "]";
	}
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((representationId == null) ? 0 : representationId.hashCode());
		result = prime * result
