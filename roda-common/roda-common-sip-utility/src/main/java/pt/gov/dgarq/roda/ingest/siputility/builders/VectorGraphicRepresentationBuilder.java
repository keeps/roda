...
/**
 * Representation builder for vector graphic.
 *
 * @author Vladislav Korecký <vladislav_korecky@gordic.cz>
 */
public class VectorGraphicRepresentationBuilder extends RepresentationBuilder {

    private static final Logger logger = Logger
            .getLogger(VectorGraphicRepresentationBuilder.class);
    ...
    public StreamRepresentationObject createRepresentation(
        ...
        return createRepresentation(SIPRepresentationObject.VECTOR_GRAPHIC,
