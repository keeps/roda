...
/**
 * Representation builder for email.
 *
 * @author Vladislav Korecký <vladislav_korecky@gordic.cz>
 */
public class EmailRepresentationBuilder extends RepresentationBuilder {

    private static final Logger logger = Logger
            .getLogger(EmailRepresentationBuilder.class);
    ...
    public StreamRepresentationObject createRepresentation(
        ...
        return createRepresentation(SIPRepresentationObject.EMAIL,
