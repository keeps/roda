...
/**
 * Representation builder for audio.
 *
 * @author Rui Castro
 * @author Vladislav Korecký <vladislav_korecky@gordic.cz>
 */
public class AudioRepresentationBuilder extends RepresentationBuilder {

    private static final Logger logger = Logger
            .getLogger(AudioRepresentationBuilder.class);
    ...
    public StreamRepresentationObject createRepresentation(
        ...
        return createRepresentation(SIPRepresentationObject.AUDIO, subType,
