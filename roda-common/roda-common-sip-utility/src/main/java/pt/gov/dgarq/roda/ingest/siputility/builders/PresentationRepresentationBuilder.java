...
/**
 * Representation builder for presentation.
 *
 * @author Vladislav Korecký <vladislav_korecky@gordic.cz>
 */
public class PresentationRepresentationBuilder extends RepresentationBuilder {

    private static final Logger logger = Logger
            .getLogger(PresentationRepresentationBuilder.class);
    ...
    public StreamRepresentationObject createRepresentation(
        ...
        return createRepresentation(SIPRepresentationObject.PRESENTATION,
