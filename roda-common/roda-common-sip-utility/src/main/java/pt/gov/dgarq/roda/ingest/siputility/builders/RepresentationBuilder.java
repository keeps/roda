...
public abstract class RepresentationBuilder {
	 ...
	 * 
	 * @param type
	 *            the type of the representation. Must be one of
	 *            {@link SIPRepresentationObject#TYPES}.
	 * @param filenames
	 *            the names of the files
	 * @param streams
	 *            the {@link InputStream}s for the files.
	 * 
	...
	public static String getFileMimetype(File file) {
		return FormatUtility.getMimetype(file);
	}
	 ...
	 * 
	 * @param rObject
	 *            the {@link RepresentationObject}. It must have a type defined.
	 * 
	 ...
	 * 
	 * @throws SIPException
	 *             if some problem occurs creating the representation.
	 */
	...
	protected StreamRepresentationFile createStreamRepresentationFile(
		...
		representationStream.setMimetype(FormatUtility.getMimetype(filename,
				inputStream));
