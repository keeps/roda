...
public class AgentPreservationObject extends PreservationObject {
  ...
  public AgentPreservationObject(AgentPreservationObject agent) {
    this(agent.getPid(), agent.getLabel(), agent.getContentModel(), agent.getLastModifiedDate(),
   ...
   * @param state
   */
  public AgentPreservationObject(String pid, String label, String model, Date lastModifiedDate, Date createdDate,
    String state) {
