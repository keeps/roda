...
import pt.gov.dgarq.roda.core.common.InvalidTaskStateException;
...
public class TaskInstance implements Serializable {
	...
	public static final String[] STATES = new String[] { STATE_RUNNING,
	...
	public TaskInstance(TaskInstance taskInstance)
			throws InvalidTaskStateException {
		this(taskInstance.getId(), taskInstance.getName(), taskInstance
				.getDescription(), taskInstance.getUsername(), taskInstance
				.getPluginInfo(), taskInstance.getState(), taskInstance
				.getCompletePercentage(), taskInstance.getStartDate(),
				taskInstance.getFinishDate(), taskInstance.getReportID());
	}
	 ...
	 *             if the state is not a valid state.
	 */
	public TaskInstance(String id, String name, String description,
			String username, PluginInfo pluginInfo, String state,
			float completePercentage, Date startDate, Date finishDate,
			String reportID) throws InvalidTaskStateException {
		setId(id);
		setName(name);
	...
	public String toString() {
		...
		return "TaskInstance(" + "id=" + getId() + ", name=" + getName()
				+ ", description=" + getDescription() + ", username="
				+ getUsername() + ", pluginInfo=" + getPluginInfo()
				+ ", state=" + getState() + ", completePercentage="
				+ getCompletePercentage() + ", startDate=" + getStartDate()
				+ ", finishDate=" + getFinishDate() + ", report="
				+ getReportID() + ")";
	}
	...
	public void setState(String state) throws InvalidTaskStateException {
		if (Arrays.asList(STATES).contains(state)) {
			...
			throw new InvalidTaskStateException("state " + state
