...
public class ArrangementTableGroup implements Serializable {
   ...
   * @param body
   */
  public ArrangementTableGroup(int columns, ArrangementTableHead head, ArrangementTableBody body) {
    setColumns(columns);
    setHead(head);
    setBody(body);
  }
  ...
  public boolean equals(Object obj) {
    if (obj instanceof ArrangementTableGroup) {
      ...
      return (this.getColumns() == other.getColumns())
        && (this.getHead() == other.getHead() || this.getHead().equals(other.getHead()))
        && (this.getBody() == other.getBody() || this.getBody().equals(other.getBody()));
    } else {
      return false;
    }
  }
