...
public class DescriptionLevelCategory implements EadCValue, Serializable {
	...
	public static final DescriptionLevelCategory ORGANIZATIONAL = new DescriptionLevelCategory(
			"organizational");

	public static final DescriptionLevelCategory CATEGORIZATION = new DescriptionLevelCategory(
			"categorization");
	...
	public static final DescriptionLevelCategory REPRESENTATIONAL = new DescriptionLevelCategory(
			"representational");

	public static List<DescriptionLevelCategory> CATEGORIES = Arrays.asList(
			ORGANIZATIONAL, CATEGORIZATION, INTELLECTUAL_ENTITY,
			INTELLECTUAL_SUBDIVISION, MECHANIC_SUBDIVISION, REPRESENTATIONAL);
