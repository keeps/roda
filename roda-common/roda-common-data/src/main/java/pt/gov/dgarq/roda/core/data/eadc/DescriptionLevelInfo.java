...
public class DescriptionLevelInfo implements EadCValue, Serializable {
	...
	public DescriptionLevelInfo(String level,
			DescriptionLevelCategory category, Map<String, String> labels) {
		super();
		this.level = level;
	...
	public String toString() {
		return "DescriptionLevelInfo [level=" + level + ", category="
