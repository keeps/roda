...
public class SimpleDescriptionObject extends RODAObject {
	...
	/**
	 * Constructs a new (<strong>invalid</strong>)
	 * {@link SimpleDescriptionObject} from a {@link RODAObject}.
	 * 
	 * @param rodaObject
	 */
	...
	public SimpleDescriptionObject(SimpleDescriptionObject other) {
		this(other.getPid(), other.getLabel(), other.getContentModel(), other
				.getLastModifiedDate(), other.getCreatedDate(), other
				.getState(), other.getLevel(), other.getCountryCode(), other
				.getRepositoryCode(), other.getId(), other.getTitle(), other
				.getDateInitial(), other.getDateFinal(),
				other.getDescription(), other.getParentPID(), other
						.getSubElementsCount());
	}
	 ...
	 */
	public SimpleDescriptionObject(String pid, String label,
			String contentModel, Date lastModifiedDate, Date createdDate,
			String state, DescriptionLevel level, String countryCode,
			String repositoryCode, String id, String title, String dateInitial,
			String dateFinal, String description, String parentPID,
	...
	public String toString() {
		return "SimpleDescriptionObject(" + super.toString() + ", " + "level="
				+ getLevel() + ", countryCode=" + getCountryCode()
				+ ", repositoryCode=" + getRepositoryCode() + ", id=" + getId()
				+ ", title=" + getTitle() + ", dateInitial=" + getDateInitial()
				+ ", dateFinal=" + getDateFinal() + ", description="
				+ getDescription() + ", parentPID=" + getParentPID()
				+ ", childCount=" + getSubElementsCount() + ")";
	}
	...
	protected String checkEadCText(String element, EadCValue value)
			throws IllegalArgumentException {
		...
		if (value == null) {
			...
			throw new IllegalArgumentException("illegal value for element "
					+ element + ". Value of type " + Text.class
					+ " was expected.");
		}
	}

	protected DescriptionLevel checkDescriptionLevel(String element,
		...
		if (value == null) {
			...
			throw new IllegalArgumentException("illegal value for element "
					+ element + ". Value of type " + DescriptionLevel.class
					+ " was expected.");
		}
	}
