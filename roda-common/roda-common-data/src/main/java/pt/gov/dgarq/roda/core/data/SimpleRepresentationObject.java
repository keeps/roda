...
public class SimpleRepresentationObject extends RODAObject {
  ...
  public static final String[] TYPES = new String[] {EMAIL, STRUCTURED_TEXT, PRESENTATION, SPREADSHEET, VECTOR_GRAPHIC,
    DIGITALIZED_WORK, AUDIO, VIDEO, RELATIONAL_DATABASE, APPLICATION_DATA, UNKNOWN};
  ...
  public static final String[] STATUSES = new String[] {STATUS_ORIGINAL, STATUS_NORMALIZED, STATUS_ALTERNATIVE};
  ...
  public String toString() {
    ...
    return "SimpleRepresentationObject( " + super.toString() + ", statuses=" + Arrays.toString(getStatuses())
   ...
   */
  public void setStatuses(String[] statuses) throws NullPointerException, IllegalArgumentException {
  ...
  public void addStatus(String status) {
    if (status == null) {
      ...
      if (STATUSES_LIST.contains(status)) {
        ...
        throw new IllegalArgumentException("'" + status + "' is not a valid status value.");
      }
