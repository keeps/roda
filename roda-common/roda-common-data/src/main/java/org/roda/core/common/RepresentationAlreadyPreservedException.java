 ...
 * 
 */
public class RepresentationAlreadyPreservedException extends RODAServiceException {
   ...
   *          the cause exception.
   */
  public RepresentationAlreadyPreservedException(String message, Throwable cause) {
    super(message, cause);
  }
