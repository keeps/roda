...
public class SIPReport implements Serializable, Comparable<SIPReport> {
  ...
  public SIPReport(SIPReport sip) {
    this(sip.getId(), sip.getUsername(), sip.getOriginalFilename(), sip.getState(), sip.getStateTransitions(), sip
      .isComplete(), sip.getCompletePercentage(), sip.getIngestedID(), sip.getParentID(), sip.getDatetime(), sip
      .isProcessing());
  }
   ...
   * @param processing
   */
  public SIPReport(String id, String username, String originalFilename, String state,
    SIPStateTransition[] stateTransitions, boolean complete, float completePercentage, String ingestedDOID,
  ...
  public String toString() {
    return "SIPState (id=" + getId() + ", username=" + getUsername() + ", originalFilename=" + getOriginalFilename()
      ...
      + "% " + ", ingestedID=" + getIngestedID() + ", parentID=" + getParentID() + ", datetime=" + getDatetime()
   ...
   * 
   * @return <code>true<code> if the {@link SIPReport}s differ in their states, <code>false<code> if nothing has changed in the {@link SIPReport}.
   * 
