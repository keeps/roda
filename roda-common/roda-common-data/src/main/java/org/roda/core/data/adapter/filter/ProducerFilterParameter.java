...
public class ProducerFilterParameter extends FilterParameter {
   ...
   */
  public ProducerFilterParameter(ProducerFilterParameter producerFilterParameter) {
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj instanceof ProducerFilterParameter) {
      ...
      equal = equal && (getUsername() == other.getUsername() || getUsername().equals(other.getUsername()));
    } else {
      equal = false;
    }
