...
public class FileFormat implements Serializable {
   ...
   */
  public FileFormat(String name, String version, String puid, String mimetype, String formatRegistryName,
    String[] extensions) {
    this.name = name;
   ...
   *
   * @param FileFormat
   *          the {@link FileFormat} to clone.
   */
  public FileFormat(FileFormat fileFormat) {
    this(fileFormat.getName(), fileFormat.getVersion(), fileFormat.getPuid(), fileFormat.getMimetype(), fileFormat
      .getFormatRegistryName(), fileFormat.getExtensions());
  }
  ...
  /**
   * @param extensions
   *          the file format extensions for this format
   */
