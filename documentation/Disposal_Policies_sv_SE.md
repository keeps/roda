...
Gallringsundantag är ett beslut som stoppar den normala processen för gallring och som innebär att arkivobjekt inte kommer att gallras. När gallringsundantaget är associerat med ett arkivobjekt kommer gallring inte att ske så länge som gallringsundantaget är aktivt i systsmet. När undataget inaktiveras, kommer gallringsprocessen att fortsätta. 
