...
public class LoggerSoapBindingStub extends org.apache.axis.client.Stub implements pt.gov.dgarq.roda.core.stubs.Logger {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("addLogEntry");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://services.core.roda.dgarq.gov.pt", "logEntry"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://data.core.roda.dgarq.gov.pt", "LogEntry"), pt.gov.dgarq.roda.core.data.LogEntry.class, false, false);
    ...
    public LoggerSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public LoggerSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public LoggerSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://services.core.roda.dgarq.gov.pt", "ArrayOf_tns1_LogEntryParameter");
            cachedSerQNames.add(qName);
            cls = pt.gov.dgarq.roda.core.data.LogEntryParameter[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://data.core.roda.dgarq.gov.pt", "LogEntryParameter");
    ...
    public void addLogEntry(pt.gov.dgarq.roda.core.data.LogEntry logEntry) throws java.rmi.RemoteException, pt.gov.dgarq.roda.core.common.LoggerException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://services.core.roda.dgarq.gov.pt", "addLogEntry"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {logEntry});
