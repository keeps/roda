...
public class AcceptSIPSoapBindingStub extends org.apache.axis.client.Stub implements pt.gov.dgarq.roda.core.stubs.AcceptSIP {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("acceptSIP");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://services.core.roda.dgarq.gov.pt", "sipID"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://services.core.roda.dgarq.gov.pt", "accept"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"), boolean.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://services.core.roda.dgarq.gov.pt", "reason"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://data.core.roda.dgarq.gov.pt", "SIPState"));
        oper.setReturnClass(pt.gov.dgarq.roda.core.data.SIPState.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://services.core.roda.dgarq.gov.pt", "acceptSIPReturn"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://services.core.roda.dgarq.gov.pt", "fault"),
                      "pt.gov.dgarq.roda.core.common.NoSuchSIPException",
                      new javax.xml.namespace.QName("http://common.core.roda.dgarq.gov.pt", "NoSuchSIPException"), 
                      true
                     ));
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://services.core.roda.dgarq.gov.pt", "fault2"),
                      "pt.gov.dgarq.roda.core.common.AcceptSIPException",
                      new javax.xml.namespace.QName("http://common.core.roda.dgarq.gov.pt", "AcceptSIPException"), 
                      true
                     ));
        oper.addFault(new org.apache.axis.description.FaultDesc(
    ...
    public AcceptSIPSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public AcceptSIPSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public AcceptSIPSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://common.core.roda.dgarq.gov.pt", "AcceptSIPException");
            cachedSerQNames.add(qName);
            cls = pt.gov.dgarq.roda.core.common.AcceptSIPException.class;
            ...
            qName = new javax.xml.namespace.QName("http://common.core.roda.dgarq.gov.pt", "NoSuchSIPException");
            cachedSerQNames.add(qName);
            cls = pt.gov.dgarq.roda.core.common.NoSuchSIPException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://data.core.roda.dgarq.gov.pt", "SIPState");
            cachedSerQNames.add(qName);
            cls = pt.gov.dgarq.roda.core.data.SIPState.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://data.core.roda.dgarq.gov.pt", "SIPStateTransition");
            cachedSerQNames.add(qName);
            cls = pt.gov.dgarq.roda.core.data.SIPStateTransition.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://services.core.roda.dgarq.gov.pt", "ArrayOf_tns1_SIPStateTransition");
            cachedSerQNames.add(qName);
            cls = pt.gov.dgarq.roda.core.data.SIPStateTransition[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://data.core.roda.dgarq.gov.pt", "SIPStateTransition");
    ...
    public pt.gov.dgarq.roda.core.data.SIPState acceptSIP(java.lang.String sipID, boolean accept, java.lang.String reason) throws java.rmi.RemoteException, pt.gov.dgarq.roda.core.common.NoSuchSIPException, pt.gov.dgarq.roda.core.common.AcceptSIPException, pt.gov.dgarq.roda.core.common.IllegalOperationException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://services.core.roda.dgarq.gov.pt", "acceptSIP"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {sipID, new java.lang.Boolean(accept), reason});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (pt.gov.dgarq.roda.core.data.SIPState) _resp;
            } catch (java.lang.Exception _exception) {
                return (pt.gov.dgarq.roda.core.data.SIPState) org.apache.axis.utils.JavaUtils.convert(_resp, pt.gov.dgarq.roda.core.data.SIPState.class);
            }
        }
    ...
    if (axisFaultException.detail != null) {
        ...
        if (axisFaultException.detail instanceof pt.gov.dgarq.roda.core.common.NoSuchSIPException) {
              throw (pt.gov.dgarq.roda.core.common.NoSuchSIPException) axisFaultException.detail;
         }
        if (axisFaultException.detail instanceof pt.gov.dgarq.roda.core.common.AcceptSIPException) {
              throw (pt.gov.dgarq.roda.core.common.AcceptSIPException) axisFaultException.detail;
         }
