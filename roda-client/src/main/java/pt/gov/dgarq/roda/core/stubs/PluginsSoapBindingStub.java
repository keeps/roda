...
public class PluginsSoapBindingStub extends org.apache.axis.client.Stub implements pt.gov.dgarq.roda.core.stubs.Plugins {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("getPluginsInfo");
        oper.setReturnType(new javax.xml.namespace.QName("http://data.core.roda.dgarq.gov.pt", "PluginInfo"));
        oper.setReturnClass(pt.gov.dgarq.roda.core.data.PluginInfo[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://services.core.roda.dgarq.gov.pt", "getPluginsInfoReturn"));
    ...
    public PluginsSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public PluginsSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public PluginsSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://services.core.roda.dgarq.gov.pt", "ArrayOf_tns1_PluginParameter");
            cachedSerQNames.add(qName);
            cls = pt.gov.dgarq.roda.core.data.PluginParameter[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://data.core.roda.dgarq.gov.pt", "PluginParameter");
    ...
    public pt.gov.dgarq.roda.core.data.PluginInfo[] getPluginsInfo() throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://services.core.roda.dgarq.gov.pt", "getPluginsInfo"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (pt.gov.dgarq.roda.core.data.PluginInfo[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (pt.gov.dgarq.roda.core.data.PluginInfo[]) org.apache.axis.utils.JavaUtils.convert(_resp, pt.gov.dgarq.roda.core.data.PluginInfo[].class);
            }
        }
