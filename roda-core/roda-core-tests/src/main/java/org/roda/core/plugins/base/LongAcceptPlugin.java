 ...
 */
public class LongAcceptPlugin extends AbstractPlugin<AIP> {
  @Override
  ...
  private void processAIP(ModelService model, IndexService index, Report report, JobPluginInfo jobPluginInfo, Job job,
    ...
    try {
      ...
      report.setPluginState(PluginState.FAILURE)
        .setPluginDetails("Thread interrupted, failed to update job counters. Interrupting again.");
