...
public class IngestHelper extends EditorHelper {
	...
	private RepresentationFilePreservationObject createRepresentationFilePreservationObject(
		...
		// pObjectFile.setFormatDesignationVersion();

		// <format><formatRegistry>
		// pObjectFile.setFormatRegistryName("JHOVE");
		// pObjectFile.setFormatRegistryKey("XXX");
		// pObjectFile.setFormatRegistryRole("don't know");
