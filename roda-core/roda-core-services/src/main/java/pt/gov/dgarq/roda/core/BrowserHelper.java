...
public class BrowserHelper {
	 ...
	 *         <code>null</code> if the given {@link DescriptionObject} doesn't
	 *         contain an original {@link RepresentationObject}.
	 * 
	 * @throws NoSuchRODAObjectException
	 *             the the specified <code>doPID</code> doesn't exist.
	 * @throws BrowserException
	 */
	 ...
	 *         <code>null</code> if the given {@link DescriptionObject} doesn't
	 *         contain an normalized {@link RepresentationObject}.
	 * 
	 * @throws NoSuchRODAObjectException
	 *             if the specified {@link DescriptionObject} PID doesn't exist.
	 * 
	 * @throws BrowserException
	 */
	 ...
	 * 
	 * @throws NoSuchRODAObjectException
	 *             if the specified PID does not exist.
	 * @throws BrowserException
	 ...
	 * 
	 * @return an <code>int</code> with the number of
	 *         {@link SimpleRepresentationPreservationObject}s that match the
	 *         given {@link Filter} .
	 * @throws BrowserException
	 */
	 ...
	 *         given status or <code>null</code> if the given
	 *         {@link DescriptionObject} doesn't contain a
	 *         {@link RepresentationObject} with the given status.
	 * 
	 * @throws NoSuchRODAObjectException
	 *             the the specified <code>doPID</code> doesn't exist.
	 * @throws BrowserException
