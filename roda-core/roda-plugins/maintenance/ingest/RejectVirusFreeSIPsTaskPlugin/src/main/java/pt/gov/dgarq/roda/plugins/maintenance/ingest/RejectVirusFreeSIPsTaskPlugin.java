 ...
 * @author Rui Castro
 */
public class RejectVirusFreeSIPsTaskPlugin extends AbstractRejectSIPTaskPlugin {
	static final private Logger logger = Logger
			.getLogger(RejectVirusFreeSIPsTaskPlugin.class);

	private final String name = "Ingest Maintenance/Reject 'VIRUS_FREE' SIPs"; //$NON-NLS-1$
	private final float version = 1.0f;
	private final String description = "Rejects SIPs in state 'VIRUS_FREE' that match the specified parameters."; //$NON-NLS-1$

	/**
	 * @throws InvalidIngestStateException
	 * @throws IngestRegistryException
	 */
	public RejectVirusFreeSIPsTaskPlugin() throws InvalidIngestStateException,
