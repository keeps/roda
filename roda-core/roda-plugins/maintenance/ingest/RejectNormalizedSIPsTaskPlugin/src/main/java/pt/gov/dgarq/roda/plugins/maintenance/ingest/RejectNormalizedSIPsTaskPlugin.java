 ...
 * @author Rui Castro
 */
public class RejectNormalizedSIPsTaskPlugin extends AbstractRejectSIPTaskPlugin {
	static final private Logger logger = Logger
			.getLogger(RejectNormalizedSIPsTaskPlugin.class);

	private final String name = "Ingest Maintenance/Reject 'SIP_NORMALIZED' SIPs"; //$NON-NLS-1$
	private final float version = 1.0f;
	private final String description = "Rejects SIPs in state 'SIP_NORMALIZED' that match the specified parameters."; //$NON-NLS-1$

	/**
	 * @throws InvalidIngestStateException
	 * @throws IngestRegistryException
	 */
	public RejectNormalizedSIPsTaskPlugin() throws InvalidIngestStateException,
