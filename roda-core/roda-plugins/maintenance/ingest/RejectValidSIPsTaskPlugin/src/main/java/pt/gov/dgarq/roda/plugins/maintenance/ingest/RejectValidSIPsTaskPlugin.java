 ...
 * @author Rui Castro
 */
public class RejectValidSIPsTaskPlugin extends AbstractRejectSIPTaskPlugin {
	static final private Logger logger = Logger
			.getLogger(RejectValidSIPsTaskPlugin.class);

	private final String name = "Ingest Maintenance/Reject 'SIP_VALID' SIPs"; //$NON-NLS-1$
	private final float version = 1.0f;
	private final String description = "Rejects SIPs in state 'SIP_VALID' that match the specified parameters."; //$NON-NLS-1$

	/**
	 * @throws InvalidIngestStateException
	 * @throws IngestRegistryException
	 */
	public RejectValidSIPsTaskPlugin() throws InvalidIngestStateException,
