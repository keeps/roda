 ...
 * @author Rui Castro
 */
public class RejectUnpackedSIPsTaskPlugin extends AbstractRejectSIPTaskPlugin {
	static final private Logger logger = Logger
			.getLogger(RejectUnpackedSIPsTaskPlugin.class);

	private final String name = "Ingest Maintenance/Reject 'UNPACKED' SIPs"; //$NON-NLS-1$
	private final float version = 1.0f;
	private final String description = "Rejects SIPs in state 'UNPACKED' that match the specified parameters."; //$NON-NLS-1$

	/**
	 * @throws InvalidIngestStateException
	 * @throws IngestRegistryException
	 */
	public RejectUnpackedSIPsTaskPlugin() throws InvalidIngestStateException,
