 ...
 * @author Rui Castro
 */
public class RejectDroppedUploadServiceSIPsTaskPlugin extends AbstractRejectSIPTaskPlugin {
	static final private Logger logger = Logger
			.getLogger(RejectDroppedUploadServiceSIPsTaskPlugin.class);

	private final String name = "Ingest Maintenance/Reject 'DROPED_UPLOAD_SERVICE' SIPs"; //$NON-NLS-1$
	private final float version = 1.0f;
	private final String description = "Rejects SIPs in state 'DROPED_UPLOAD_SERVICE' that match the specified parameters."; //$NON-NLS-1$

	/**
	 * @throws InvalidIngestStateException
	 * @throws IngestRegistryException
	 */
	public RejectDroppedUploadServiceSIPsTaskPlugin() throws InvalidIngestStateException,
