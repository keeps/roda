 ...
 * @author Rui Castro
 */
public class Bmp2TiffConverterPlugin extends AbstractRodaMigratorPlugin {
	private static Logger logger = Logger
			.getLogger(Bmp2TiffConverterPlugin.class);

	private final String name = "Converter/BMP to TIFF";
	private final float version = 1.0f;
	private final String description = "Digitalized Work BMP representations normalizer plugin. "
			+ "Convert DigitalizedWork representations with BMP images to uncompressed TIFFs using RODA Migrator service DW2Tiff.";
	...
	protected String getConfigurationFile() {
		return "bmp2tiff-converter.properties";
	}
