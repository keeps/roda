 ...
 * @author Rui Castro
 */
public class Mpeg2WavConverterPlugin extends AbstractRodaMigratorPlugin {
	private static Logger logger = Logger
			.getLogger(Mpeg2WavConverterPlugin.class);

	private final String name = "Converter/MP3 to WAV";
	private final float version = 1.0f;
	private final String description = "Audio MPEG representations normalizer plugin. "
			+ "Convert Audio representations from MPEG to WAV using RODA Migrator service Audio2Wav.";
	...
	protected String getConfigurationFile() {
		return "mpeg2wav-converter.properties";
	}
