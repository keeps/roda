 ...
 * @author Rui Castro
 */
public class Ogg2WavConverterPlugin extends AbstractRodaMigratorPlugin {
	private static Logger logger = Logger
			.getLogger(Ogg2WavConverterPlugin.class);

	private final String name = "Converter/OGG to WAV";
	private final float version = 1.0f;
	private final String description = "Audio OGG representations normalizer plugin. "
			+ "Convert Audio representations from OGG to WAV using RODA Migrator service Audio2Wav.";
	...
	protected String getConfigurationFile() {
		return "ogg2wav-converter.properties";
	}
