 ...
 * @author Rui Castro
 */
public class Flac2WavConverterPlugin extends AbstractRodaMigratorPlugin {
	private static Logger logger = Logger
			.getLogger(Flac2WavConverterPlugin.class);

	private final String name = "Converter/Flac to WAV";
	private final float version = 1.0f;
	private final String description = "Audio Flac representations normalizer plugin. "
			+ "Convert Audio representations from Flac to WAV using RODA Migrator service Audio2Wav.";
	...
	protected String getConfigurationFile() {
		return "flac2wav-converter.properties";
	}
