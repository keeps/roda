 ...
 * @author Rui Castro
 */
public class Mpeg42Mpeg2ConverterPlugin extends AbstractRodaMigratorPlugin {
	private static Logger logger = Logger
			.getLogger(Mpeg42Mpeg2ConverterPlugin.class);

	private final String name = "Converter/MPEG4 to MPEG2";
	private final float version = 1.0f;
	private final String description = "Video MPEG4 representations normalizer plugin. "
			+ "Convert Video representations from MPEG4 to MPEG2 using RODA Migrator service Video2DVD.";
	...
	protected String getConfigurationFile() {
		return "mpeg42mpeg2-converter.properties";
	}
