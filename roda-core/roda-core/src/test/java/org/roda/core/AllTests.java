...
@SuiteClasses({JsonUtilsTest.class, IndexServiceTest.class, ModelServiceTest.class, FileStorageServiceTest.class,
  FedoraStorageServiceTest.class, SolrUtilsTest.class, InternalPluginsTest.class,
  InternalConvertPluginsTestForTravis.class, EARKSIPPluginsTest.class, PermissionsTest.class})
