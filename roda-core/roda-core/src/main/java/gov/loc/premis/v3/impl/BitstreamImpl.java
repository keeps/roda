 ...
 */
public class BitstreamImpl extends gov.loc.premis.v3.impl.ObjectComplexTypeImpl implements gov.loc.premis.v3.Bitstream
{
    private static final long serialVersionUID = 1L;
    
    public BitstreamImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName SIGNIFICANTPROPERTIES$2 = 
        new javax.xml.namespace.QName("http://www.loc.gov/premis/v3", "significantProperties");
    private static final javax.xml.namespace.QName OBJECTCHARACTERISTICS$4 = 
        new javax.xml.namespace.QName("http://www.loc.gov/premis/v3", "objectCharacteristics");
    private static final javax.xml.namespace.QName STORAGE$6 = 
        new javax.xml.namespace.QName("http://www.loc.gov/premis/v3", "storage");
    private static final javax.xml.namespace.QName SIGNATUREINFORMATION$8 = 
    ...
    public gov.loc.premis.v3.SignificantPropertiesComplexType[] getSignificantPropertiesArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List targetList = new java.util.ArrayList();
            get_store().find_all_element_users(SIGNIFICANTPROPERTIES$2, targetList);
    ...
    public gov.loc.premis.v3.SignificantPropertiesComplexType getSignificantPropertiesArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (gov.loc.premis.v3.SignificantPropertiesComplexType)get_store().find_element_user(SIGNIFICANTPROPERTIES$2, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public int sizeOfSignificantPropertiesArray()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(SIGNIFICANTPROPERTIES$2);
        }
    }
    ...
    {
        check_orphaned();
        arraySetterHelper(significantPropertiesArray, SIGNIFICANTPROPERTIES$2);
    }
    ...
    public gov.loc.premis.v3.SignificantPropertiesComplexType insertNewSignificantProperties(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.loc.premis.v3.SignificantPropertiesComplexType target = null;
            target = (gov.loc.premis.v3.SignificantPropertiesComplexType)get_store().insert_element_user(SIGNIFICANTPROPERTIES$2, i);
            return target;
        }
    }
    ...
    public gov.loc.premis.v3.SignificantPropertiesComplexType addNewSignificantProperties()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.loc.premis.v3.SignificantPropertiesComplexType target = null;
            target = (gov.loc.premis.v3.SignificantPropertiesComplexType)get_store().add_element_user(SIGNIFICANTPROPERTIES$2);
            return target;
        }
    }
    ...
    public void removeSignificantProperties(int i)
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(SIGNIFICANTPROPERTIES$2, i);
        }
    }
    ...
    public gov.loc.premis.v3.ObjectCharacteristicsComplexType[] getObjectCharacteristicsArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List targetList = new java.util.ArrayList();
            get_store().find_all_element_users(OBJECTCHARACTERISTICS$4, targetList);
    ...
    public gov.loc.premis.v3.ObjectCharacteristicsComplexType getObjectCharacteristicsArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (gov.loc.premis.v3.ObjectCharacteristicsComplexType)get_store().find_element_user(OBJECTCHARACTERISTICS$4, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public int sizeOfObjectCharacteristicsArray()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(OBJECTCHARACTERISTICS$4);
        }
    }
    ...
    {
        check_orphaned();
        arraySetterHelper(objectCharacteristicsArray, OBJECTCHARACTERISTICS$4);
    }
    ...
    public gov.loc.premis.v3.ObjectCharacteristicsComplexType insertNewObjectCharacteristics(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.loc.premis.v3.ObjectCharacteristicsComplexType target = null;
            target = (gov.loc.premis.v3.ObjectCharacteristicsComplexType)get_store().insert_element_user(OBJECTCHARACTERISTICS$4, i);
            return target;
        }
    }
    ...
    public gov.loc.premis.v3.ObjectCharacteristicsComplexType addNewObjectCharacteristics()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.loc.premis.v3.ObjectCharacteristicsComplexType target = null;
            target = (gov.loc.premis.v3.ObjectCharacteristicsComplexType)get_store().add_element_user(OBJECTCHARACTERISTICS$4);
            return target;
        }
    }
    ...
    public void removeObjectCharacteristics(int i)
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(OBJECTCHARACTERISTICS$4, i);
        }
    }
    ...
    public gov.loc.premis.v3.StorageComplexType[] getStorageArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List targetList = new java.util.ArrayList();
            get_store().find_all_element_users(STORAGE$6, targetList);
    ...
    public gov.loc.premis.v3.StorageComplexType getStorageArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (gov.loc.premis.v3.StorageComplexType)get_store().find_element_user(STORAGE$6, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public int sizeOfStorageArray()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(STORAGE$6);
        }
    }
    ...
    {
        check_orphaned();
        arraySetterHelper(storageArray, STORAGE$6);
    }
    ...
    public gov.loc.premis.v3.StorageComplexType insertNewStorage(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.loc.premis.v3.StorageComplexType target = null;
            target = (gov.loc.premis.v3.StorageComplexType)get_store().insert_element_user(STORAGE$6, i);
            return target;
        }
    }
    ...
    public gov.loc.premis.v3.StorageComplexType addNewStorage()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.loc.premis.v3.StorageComplexType target = null;
            target = (gov.loc.premis.v3.StorageComplexType)get_store().add_element_user(STORAGE$6);
            return target;
        }
    }
    ...
    public gov.loc.premis.v3.SignatureInformationComplexType[] getSignatureInformationArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List targetList = new java.util.ArrayList();
            get_store().find_all_element_users(SIGNATUREINFORMATION$8, targetList);
    ...
    public gov.loc.premis.v3.SignatureInformationComplexType getSignatureInformationArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (gov.loc.premis.v3.SignatureInformationComplexType)get_store().find_element_user(SIGNATUREINFORMATION$8, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public int sizeOfSignatureInformationArray()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(SIGNATUREINFORMATION$8);
        }
    }
    ...
    {
        check_orphaned();
        arraySetterHelper(signatureInformationArray, SIGNATUREINFORMATION$8);
    }
    ...
    public gov.loc.premis.v3.SignatureInformationComplexType insertNewSignatureInformation(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.loc.premis.v3.SignatureInformationComplexType target = null;
            target = (gov.loc.premis.v3.SignatureInformationComplexType)get_store().insert_element_user(SIGNATUREINFORMATION$8, i);
            return target;
        }
    }
    ...
    public gov.loc.premis.v3.SignatureInformationComplexType addNewSignatureInformation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.loc.premis.v3.SignatureInformationComplexType target = null;
            target = (gov.loc.premis.v3.SignatureInformationComplexType)get_store().add_element_user(SIGNATUREINFORMATION$8);
            return target;
        }
    }
    ...
    public void removeSignatureInformation(int i)
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(SIGNATUREINFORMATION$8, i);
        }
    }
