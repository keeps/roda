...
public final class PremisV3Utils {
  ...
  public static ContentPayload createBaseFile(File originalFile, ModelService model,
    ...
    oict.setObjectIdentifierValue(
      URNUtils.createRodaPreservationURN(PreservationMetadataType.FILE, originalFile.getId(), LocalInstanceUtils.getLocalInstanceIdentifier()));
    ...
    oict2.setObjectIdentifierValue(
            URNUtils.createRodaPreservationURN(PreservationMetadataType.FILE, fileUUID, LocalInstanceUtils.getLocalInstanceIdentifier()));
  ...
  public static PreservationMetadata createOrUpdatePremisUserAgentBinary(String username, ModelService model,
    ...
    if (StringUtils.isNotBlank(username)) {
      String id = IdUtils.getUserAgentId(username, LocalInstanceUtils.getLocalInstanceIdentifier());
      String fullName = "";
      String extension = "";
      String note = "";
      String version = "";
