...
public class TransactionLog implements Serializable {
  ...
  public List<String> getStoragePaths() {
    return storagePaths.stream().map(TransactionalStoragePath::getStoragePath).toList();
  }

  public void removeStoragePath(String storagePath) {
    if (storagePath != null) {
  ...
  public void addStoragePath(StoragePath storagePath) {
    if (storagePath != null) {
      TransactionalStoragePath transactionalStoragePath = new TransactionalStoragePath(storagePath);
