...
public class ChronListEditor implements MetadataElementEditor {
  ...
  public class ChronItemEditor {
    ...
    public BioghistChronitem getChronItem() {
      ...
      if (initialDate.getISODate() != null || finalDate.getISODate() != null) {
        ret = new BioghistChronitem(content.getText(), initialDate.getISODate(), finalDate.getISODate());
      }
      return ret;
    }
  ...
  public ChronListEditor() {
    ...
    addChronItem = new WUIButton(constants.newChronItem(), WUIButton.Left.ROUND, WUIButton.Right.PLUS);
  ...
  public EadCValue getValue() {
    ...
    return chronItems.size() == 0 ? null : new BioghistChronlist(chronItems.toArray(new BioghistChronitem[] {}));
  }
