...
public class DescriptionLevelServiceImpl extends RemoteServiceServlet implements
	...
	private static final Logger logger = Logger
			.getLogger(DescriptionLevelServiceImpl.class);
	...
	public DescriptionLevelInfoPack getAllDescriptionLevels() {
		...
		pack.setDescriptionLevelsInfo(DescriptionLevelManager
				.getDescriptionLevelsInfo());
		pack.setDescriptionLevels(DescriptionLevelManager
				.getDescriptionLevels());
		pack.setRootDescriptionLevels(DescriptionLevelManager
				.getRootDescriptionLevels());
		pack.setLeafDescriptionLevels(DescriptionLevelManager
				.getLeafDescriptionLevels());
		pack.setRepresentationDescriptionLevels(DescriptionLevelManager
				.getRepresentationsDescriptionLevels());
		pack.setAllButRepresentationDescriptionLevels(DescriptionLevelManager
