...
import pt.gov.dgarq.roda.core.data.eadc.Materialspec;
...
public class MaterialSpecsEditor implements MetadataElementEditor {
	...
	public MaterialSpecsEditor() {
		...
		addMaterialSpec = new WUIButton(constants.materialSpecsAdd(),
	...
	public EadCValue getValue() {
		...
		return materialspecs.size() == 0 ? null : new Materialspecs(
				materialspecs.toArray(new Materialspec[] {}));
	}
	...
	public class MaterialSpecEditor {
		...
		public Materialspec getMaterialSpec() {
			...
			if (labelNormalTextMode && valueNormalTextMode) {
				materialspec = new Materialspec(value.getText(),
						label.getText());
			}
			return materialspec;
		}
