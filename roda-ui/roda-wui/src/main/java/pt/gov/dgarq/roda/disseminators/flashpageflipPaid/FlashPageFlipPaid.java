package pt.gov.dgarq.roda.disseminators.flashpageflipPaid;
 ...
 * 
 */
public class FlashPageFlipPaid extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   ...
   */
  public FlashPageFlipPaid() {
    resources = new HashMap<String, String>();
    resources.put("/js/AC_RunActiveContent.js",
      "/pt/gov/dgarq/roda/disseminators/flashpageflipPaid/js/AC_RunActiveContent.js");
    resources.put("/js/PopUpWin.js", "/pt/gov/dgarq/roda/disseminators/flashpageflipPaid/js/PopUpWin.js");
    resources.put("/swf/Magazine.swf", "/pt/gov/dgarq/roda/disseminators/flashpageflipPaid/swf/Magazine.swf");
    resources.put("/swf/Pages.swf", "/pt/gov/dgarq/roda/disseminators/flashpageflipPaid/swf/Pages.swf");
    resources.put("/txt/Lang.txt", "/pt/gov/dgarq/roda/disseminators/flashpageflipPaid/txt/Lang.txt");
    resources.put("/mp3/silent.mp3", "/pt/gov/dgarq/roda/disseminators/flashpageflipPaid/mp3/silent.mp3");
    ...
    cacheController = new CacheController(DISSEMINATOR_NAME, "FlashPageFlipPaid") {
      ...
      protected void createResources(HttpServletRequest request, RepresentationObject rep, String cacheURL,
        ...
        FlashPageFlipPaid.this.createResources(request, rep, cacheURL, cacheFile);
  ...
  private void sendIndex(HttpServletRequest request, RepresentationObject rep, String cacheURL,
    ...
    InputStream indexTemplate = SimpleViewer.class.getClassLoader().getResourceAsStream(
      "/pt/gov/dgarq/roda/disseminators/flashpageflipPaid/index.html");
    String index;
