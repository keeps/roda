 ...
 * 
 */
public class FlashPageFlipPaid extends javax.servlet.http.HttpServlet implements
	...
	public FlashPageFlipPaid() {
		...
		resources
				.put("/js/PopUpWin.js",
						"/pt/gov/dgarq/roda/disseminators/flashpageflipPaid/js/PopUpWin.js");
		resources
				.put("/swf/Magazine.swf",
						"/pt/gov/dgarq/roda/disseminators/flashpageflipPaid/swf/Magazine.swf");
		resources
				.put("/swf/Pages.swf",
						"/pt/gov/dgarq/roda/disseminators/flashpageflipPaid/swf/Pages.swf");
		resources
				.put("/txt/Lang.txt",
						"/pt/gov/dgarq/roda/disseminators/flashpageflipPaid/txt/Lang.txt");
		resources
				.put("/mp3/silent.mp3",
		...
		cacheController = new CacheController(DISSEMINATOR_NAME,
			...
			protected void createResources(HttpServletRequest request,
					...
					throws Exception {
				FlashPageFlipPaid.this.createResources(request, rep, cacheURL,
						cacheFile);
