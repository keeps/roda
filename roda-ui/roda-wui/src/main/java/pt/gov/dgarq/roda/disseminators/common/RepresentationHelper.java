package pt.gov.dgarq.roda.disseminators.common;
...
public class RepresentationHelper {
	 ...
	 */
	public GetMethod getRootMethod(HttpServletRequest request,
			RepresentationObject obj) throws LoginException, HttpException,
	 ...
	 * @throws RODAClientException
	 */
	public GetMethod getPartFileMethod(HttpServletRequest request,
			RepresentationObject obj, int i) throws LoginException,
	 ...
	 * @throws RODAClientException
	 */
	public InputStream getRootInputStream(HttpServletRequest request,
			RepresentationObject obj) throws LoginException, HttpException,
			IOException, RODAClientException {
		return getMethod(request, obj.getRootFile().getAccessURL())
	 ...
	 * @throws RODAClientException
	 */
	public InputStream getPartFileInputStream(HttpServletRequest request,
			RepresentationObject obj, int i) throws LoginException,
			HttpException, IOException, RODAClientException {
		return getMethod(request, obj.getPartFiles()[i].getAccessURL())
				.getResponseBodyAsStream();
	 ...
	 */
	public InputStream getPartFileInputStream(HttpServletRequest request,
			RepresentationObject obj, String id) throws LoginException,
			HttpException, IOException, RODAClientException {
		return getMethod(request,
				obj.getPartFiles()[getPartFileIndex(obj, id)].getAccessURL())
				.getResponseBodyAsStream();
	}
	 ...
	 * @throws RODAClientException
	 */
	public GetMethod getMethod(HttpServletRequest request, String path)
	 ...
	 * @throws IOException
	 */
	public void forwardMethod(GetMethod method, HttpServletResponse response)
			throws IOException {
		...
		// If special header not set, fall back to content-disposition
			...
			Header contentDisposition = method
					.getResponseHeader("Content-Disposition");
			if (contentDisposition != null
					&& contentDisposition.getValue() != null) {
	 ...
	 * @throws RODAClientException
	 */
	public void sendToDir(HttpServletRequest request, RepresentationObject rep,
			File dir) throws LoginException, HttpException, IOException,
			RODAClientException {
	 ...
	 * @throws RODAClientException
	 */
	public File sendRootToDir(HttpServletRequest request,
			RepresentationObject rep, File dir) throws LoginException,
			HttpException, IOException, RODAClientException {
		...
		send(rootMethod.getResponseBodyAsStream(), new FileOutputStream(
				rootFile));
		return rootFile;
	}
	 ...
	 * @throws RODAClientException
	 */
	public File sendPartFileToDir(HttpServletRequest request,
			RepresentationObject rep, int index, File dir)
			throws LoginException, HttpException, IOException,
			RODAClientException {
