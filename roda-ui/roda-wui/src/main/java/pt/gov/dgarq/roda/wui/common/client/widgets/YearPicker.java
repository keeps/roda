...
public class YearPicker extends TextBox {
	...
	public YearPicker() {
		 ...
		 * ((!Character.isDigit(keyCode)) && (keyCode != (char)
		 * KeyCodes.KEY_TAB) && (keyCode != (char) KeyCodes.KEY_BACKSPACE) &&
		 * (keyCode != (char) KeyCodes.KEY_DELETE) && (keyCode != (char)
		 * KeyCodes.KEY_ENTER) && (keyCode != (char) KeyCodes.KEY_HOME) &&
		 * (keyCode != (char) KeyCodes.KEY_END) && (keyCode != (char)
		 * KeyCodes.KEY_LEFT) && (keyCode != (char) KeyCodes.KEY_UP) && (keyCode
		 * != (char) KeyCodes.KEY_RIGHT) && (keyCode != (char)
		 * KeyCodes.KEY_DOWN)) { ((TextBox) sender).cancelKey(); } } });
		 */
	}
