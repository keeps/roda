...
public class FlashPageFlipFree extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
  ...
  public FlashPageFlipFree() {
    ...
    resources.put("/js/PopUpWin.js", "/pt/gov/dgarq/roda/disseminators/flashpageflipFree/js/PopUpWin.js");
    resources.put("/swf/Magazine.swf", "/pt/gov/dgarq/roda/disseminators/flashpageflipFree/swf/Magazine.swf");
    resources.put("/swf/Pages.swf", "/pt/gov/dgarq/roda/disseminators/flashpageflipFree/swf/Pages.swf");
    resources.put("/txt/Lang.txt", "/pt/gov/dgarq/roda/disseminators/flashpageflipFree/txt/Lang.txt");
