...
public class SimpleViewer extends HttpServlet implements Servlet {
	...
	public SimpleViewer() {
		...
		cacheController = new CacheController(DISSEMINATOR_NAME, "SimpleViewer") {
			...
			protected void createResources(HttpServletRequest request,
					...
					throws Exception {
				SimpleViewer.this.createResources(request, rep, cacheURL,
						cacheFile);
			}
	...
	private void sendIndex(HttpServletRequest request,
			RepresentationObject rep, String cacheURL, OutputStream out)
			throws IOException {
		...
		InputStream indexTemplate = SimpleViewer.class
				.getClassLoader()
				.getResourceAsStream(
						"/pt/gov/dgarq/roda/disseminators/simpleviewer/index.html");
