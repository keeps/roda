...
public class RestUtils {
  ...
  public static SafeUri createRepresentationDownloadUri(String aipId, String repId) {
    ...
    // rest/v1/aips/{aip_id}/data/{rep_id}/?acceptFormat=zip
    ...
    b.append(QUERY_START).append(ATTR_ACCEPT_FORMAT).append(ATTR_ASSIGN_SYMBOL).append(ATTR_ACCEPT_FORMAT_ZIP);
  ...
  public static SafeUri createDescriptiveMetadataDownloadUri(String aipId) {
    ...
    // rest/v1/aips/{aip_id}/descriptive_metadata/?acceptFormat=zip
    StringBuilder b = new StringBuilder();
    // base uri
