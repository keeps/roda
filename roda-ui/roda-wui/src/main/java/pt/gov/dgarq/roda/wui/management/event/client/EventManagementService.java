...
public interface EventManagementService extends RemoteService {
	...
	public static class Util {
		...
		public static EventManagementServiceAsync getInstance() {
			...
			EventManagementServiceAsync instance = (EventManagementServiceAsync) GWT
					.create(EventManagementService.class);
	 ...
	 * @throws PrintReportException
	 */
	public void setInstanceListReportInfo(ContentAdapter adapter, String locale)
			throws PrintReportException;
