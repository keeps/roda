 ...
 */
package org.roda.disseminators.flashpageflipPaid;
...
import org.roda.disseminators.flashpageflipFree.FlashPageFlipFree;
...
public class FlashPageFlipPaid extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
  ...
  public FlashPageFlipPaid() {
    ...
    resources.put("/js/AC_RunActiveContent.js",
      "/org/roda/disseminators/flashpageflipPaid/js/AC_RunActiveContent.js");
    resources.put("/js/PopUpWin.js", "/org/roda/disseminators/flashpageflipPaid/js/PopUpWin.js");
    resources.put("/swf/Magazine.swf", "/org/roda/disseminators/flashpageflipPaid/swf/Magazine.swf");
    resources.put("/swf/Pages.swf", "/org/roda/disseminators/flashpageflipPaid/swf/Pages.swf");
    resources.put("/txt/Lang.txt", "/org/roda/disseminators/flashpageflipPaid/txt/Lang.txt");
    resources.put("/mp3/silent.mp3", "/org/roda/disseminators/flashpageflipPaid/mp3/silent.mp3");
  ...
  private void sendIndex(HttpServletRequest request, RepresentationObject rep, String cacheURL,
    ...
    InputStream indexTemplate = SimpleViewer.class.getClassLoader().getResourceAsStream(
      "/org/roda/disseminators/flashpageflipPaid/index.html");
    String index;
