...
import org.roda.wui.dissemination.browse.client.ArrangementTableGroupPanel;
import org.roda.wui.dissemination.client.images.EditorsIconBundle;
  ...
  private Widget createReadonlyWidget() {
    ...
    if (value != null) {
      if (value instanceof Text) {
        ...
        ret = new Label(Dissemination.getInstance().getElementLevelTranslation((DescriptionLevel) value));
