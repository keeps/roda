...
public class ListHeader extends Composite implements SourcesClickEvents {
   ...
   */
  public ListHeader(String text, String stylename, SortParameter[] sortParameters, boolean defaultSortDirection) {
    ...
    layout.setCellVerticalAlignment(sortDirection, HasAlignment.ALIGN_MIDDLE);
