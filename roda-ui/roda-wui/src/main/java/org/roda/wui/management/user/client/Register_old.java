...
public class Register_old implements HistoryResolver {

  private static Register_old instance = null;
   ...
   * @return the instance
   */
  public static Register_old getInstance() {
    if (instance == null) {
      instance = new Register_old();
    }
    return instance;
  }
