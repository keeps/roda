...
public class Formats extends RodaWuiController {
  ...
  public static void deleteFormat(RodaSimpleUser user, String formatId)
  ...
  public static List<Format> retrieveFormats(RodaSimpleUser user, IndexResult<Format> listFormatsIndexResult)
