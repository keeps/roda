...
public class RiskDetailsPanel extends GenericMetadataCardPanel<Risk> {
  ...
  protected FlowPanel createHeaderWidget(Risk risk) {
    ...
    return builder.buildGroupedListWithObjects(new ActionableObject<>(indexedRisk),
      List.of(RiskActions.IndexedRiskAction.EDIT), List.of(RiskActions.IndexedRiskAction.EDIT));
  }
