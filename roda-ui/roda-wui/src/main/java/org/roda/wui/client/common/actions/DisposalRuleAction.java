...
public enum DisposalRuleAction implements Actionable.Action<DisposalRule> {
  NEW(RodaConstants.PERMISSION_METHOD_CREATE_DISPOSAL_RULE), SAVE(RodaConstants.PERMISSION_METHOD_CREATE_DISPOSAL_RULE),
  EDIT(RodaConstants.PERMISSION_METHOD_UPDATE_DISPOSAL_RULE),
  UPDATE(RodaConstants.PERMISSION_METHOD_CREATE_DISPOSAL_RULE),
