  ...
  public static SafeHtml getFilterParameterHTML(FilterParameter parameter) {
    if (parameter instanceof SimpleFilterParameter) {
      ...
      if (p.getFromValue() != null && p.getToValue() != null) {
        ...
        return messages.searchPreFilterDateIntervalFilterParameter(messages.searchPreFilterName(p.getFromName()), fromDateHumanized, toDateHumanized);
      } else if (p.getToValue() == null) {
        String fromDateHumanized = Humanize.formatDate(p.getFromValue());
        return messages.searchPreFilterDateIntervalFilterParameterFrom(messages.searchPreFilterName(p.getFromName()), fromDateHumanized);
      } else {
        String toDateHumanized = Humanize.formatDate(p.getToValue());
        return messages.searchPreFilterDateIntervalFilterParameterTo(messages.searchPreFilterName(p.getFromName()), toDateHumanized);
      }
    } else {
