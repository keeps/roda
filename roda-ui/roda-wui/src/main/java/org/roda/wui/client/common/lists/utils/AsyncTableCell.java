...
import org.roda.wui.api.v1.IndexResource;
...
/*  private ComposableFuture<IndexResult<T>> getData(Sublist sublist, Sorter sorter, List<String> fieldsToReturn) {
    Services.future(IndexResource.class, s -> s.)
  }*/
