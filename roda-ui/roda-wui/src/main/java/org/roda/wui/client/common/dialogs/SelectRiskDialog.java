...
public class SelectRiskDialog extends DialogBox implements SelectDialog {
  private static final Binder binder = GWT.create(Binder.class);

  interface Binder extends UiBinder<Widget, SelectRiskDialog> {
  }
  ...
  public SelectRiskDialog(String title, Filter filter) {
    ...
    Facets facets = new Facets(new SimpleFacetParameter(RodaConstants.RISK_NAME));
    searchResultsPanel = new RiskList(filter, facets, "Risks", false);

    searchPanel = new SearchPanel(filter, RodaConstants.RISK_SEARCH, messages.selectAipSearchPlaceHolder(), false,
      false);
