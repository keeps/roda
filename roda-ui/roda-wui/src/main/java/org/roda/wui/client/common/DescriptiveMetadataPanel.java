...
public class DescriptiveMetadataPanel extends Composite implements SourcesChangeEvents {
  ...
  private DescriptionGroupPanel createIdentificationGroup() {
    ...
    DescriptionElement handle = new DescriptionElement(descObj, DescriptionObject.HANDLE_URL, constants.handle(), false,
      valuesAsHtml);
    ...
    DescriptionElement acqInfoNum = new DescriptionElement(descObj, DescriptionObject.ACQINFO_NUM,
      constants.acqInfoNum(), false, valuesAsHtml);

    DescriptionElement acqInfoDate = new DescriptionElement(descObj, DescriptionObject.ACQINFO_DATE,
      constants.acqInfoDate(), false, valuesAsHtml);
    ...
    DescriptionElement physDescDateInitial = new DescriptionElement(descObj, DescriptionObject.PHYSDESC_DATE_INITIAL,
  ...
  private DescriptionGroupPanel createContextGroup() {
    ...
    DescriptionElement acqinfo = new DescriptionElement(descObj, DescriptionObject.ACQINFO, constants.acqinfo(), false,
      valuesAsHtml);
  ...
  private DescriptionGroupPanel createContentGroup() {
    ...
    DescriptionElement appraisal = new DescriptionElement(descObj, DescriptionObject.APPRAISAL, constants.appraisal(),
      false, valuesAsHtml);
  ...
  private DescriptionGroupPanel createNotesGroup() {
    ...
    DescriptionElement notes = new DescriptionElement(descObj, DescriptionObject.NOTE, constants.notes(), false,
      valuesAsHtml);
    DescriptionElement keywords = new DescriptionElement(descObj, DescriptionObject.INDEX, constants.keywords(), false,
      valuesAsHtml);
   ...
   * 
   * @param callback
   *          Handle called when commit finished. The argument is the changed
   *          DescriptionObject
   */
   ...
   * @return
   * 
   * @tip Don't forget to call save before this method to make all used editors
   *      modify the description object
   */
