...
public interface EditorServiceAsync {
   ...
   * @throws RODAException
   */
  public void removeProducers(List<RODAMember> producerList, String fondsPid, AsyncCallback<List<RODAMember>> callback);
   ...
   * @throws RODAException
   */
  public void setPermission(String pid, RODAMember member, ObjectPermissions permission,
    AsyncCallback<Map<RODAMember, ObjectPermissions>> callback);
   ...
   * @throws RODAException
   */
  public void setObjectPermissions(String pid, Map<RODAMember, ObjectPermissions> permissions, boolean recursivelly,
    AsyncCallback<Map<RODAMember, ObjectPermissions>> callback);
