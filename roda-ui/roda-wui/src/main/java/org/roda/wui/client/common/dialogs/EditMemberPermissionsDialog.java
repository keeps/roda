...
public final class EditMemberPermissionsDialog {
  private static final ClientMessages messages = GWT.create(ClientMessages.class);

  private EditMemberPermissionsDialog() {
    // utility class
  }

  public static DialogBox show(IndexedAIP aip, String memberName, boolean user,
    ...
    MemberPermissionPanel permissionPanel = new MemberPermissionPanel(currentPermissions);
  ...
  private static void askApplyToHierarchyAndSave(IndexedAIP aip, String memberName, boolean user,
    MemberPermissionPanel permissionPanel, DialogBox dialogBox, AsyncCallback<Actionable.ActionImpact> callback) {
    dialogBox.hide();
  ...
  private static void savePermissions(IndexedAIP aip, String memberName, boolean user,
    MemberPermissionPanel permissionPanel, boolean recursive, AsyncCallback<Actionable.ActionImpact> callback) {
  ...
  private static class MemberPermissionPanel extends Composite {
    private final FlowPanel permissionsPanel;
    private final List<PermissionCheckBox> permissionCheckBoxes;

    public MemberPermissionPanel(Set<PermissionType> permissions) {
