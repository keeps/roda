...
public class ControllerAssistant {
  ...
  public void checkGroup(final RodaSimpleUser user, final String group) throws AuthorizationDeniedException {
    try {
  ...
  public void checkRoles(final RodaSimpleUser user) throws AuthorizationDeniedException {
    try {
  ...
  public void checkRoles(final RodaSimpleUser user, final Class<?> classToReturn) throws AuthorizationDeniedException {
    try {
  ...
  public void registerAction(final RodaSimpleUser user, final String relatedObjectId, final LOG_ENTRY_STATE state,
  ...
  public void registerAction(final RodaSimpleUser user, final LOG_ENTRY_STATE state, final Object... parameters) {
    registerAction(user, null, state, parameters);
  }

  public void registerAction(final RodaSimpleUser user, final LOG_ENTRY_STATE state) {
