...
public class TransferredResource implements TransferredResourceService {
  ...
  @Override
  public Job moveTransferredResources(SelectedItems<org.roda.core.data.v2.ip.TransferredResource> selected, org.roda.core.data.v2.ip.TransferredResource transferredResource) throws RODAException {
    User user = UserUtility.getApiUser(request);
  ...
  @Override
  public String renameTransferredResource(String resourceId, String newName, Boolean replaceExisting) throws RODAException {
    User user = UserUtility.getApiUser(request);

    return Browser.renameTransferredResource(user, resourceId, newName, replaceExisting);
  }
