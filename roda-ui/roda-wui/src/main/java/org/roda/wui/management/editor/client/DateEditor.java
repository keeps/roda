...
import org.roda.wui.management.editor.client.MaterialSpecsEditor.MaterialSpecListener;
...
public class DateEditor implements MetadataElementEditor {
   ...
   * 
   * @see
   * org.roda.office.management.editor.client.MetadataElementEditor
   * #getValue()
   */
   ...
   * @see
   * org.roda.office.management.editor.client.MetadataElementEditor
   * #setValue(org.roda.core.data.eadc.EadCValue)
   */
