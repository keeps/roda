...
public class SelectAipDialog extends DialogBox implements SelectDialog {
  ...
  @Override
  public HandlerRegistration addValueChangeHandler(ValueChangeHandler<IsIndexed> handler) {
