...
function PMA_TableHeader($db_is_information_schema = false)
{
    ...
    if ($db_is_information_schema) {
        ...
        // RODA: column span has less 3 columns because edit, clean and remove options where removed
        //$action_colspan = 6;
        $action_colspan = 3;
    }
...
<tr class="<?php echo $odd_row ? 'odd' : 'even'; $odd_row = ! $odd_row; ?>">
    ...
    <!-- RODA: removed change, clean and remove options -->
 <!--   <td align="center">
    ...
    <!-- RODA: remove DB type and collation
...
<?php
// RODA: removed empty, drop, check, optimize and repair options
...
// RODA: removed create table option 
/*
if (empty($db_is_information_schema)) {
    require './libraries/display_create_table.lib.php';
} // end if (Create Table dialog)
