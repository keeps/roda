...
<div class="header" id="top_menu">
        ...
        /></a>
        <!-- RODA: remove start new table, start relation and display field
        <a href="javascript:Start_table_new();" onmousedown="return false;"
            class="M_butt" target="_self"
        ...
        /></a> -->
        <a href="javascript:location.reload();" onmousedown="return false;"
            class="M_butt" target="_self"
        ><img title="<?php echo $strReload; ?>" src="pmd/images/reload.png" alt=""
        /></a>
        <!-- RODA: remove help
        <a href="javascript:Help();" onmousedown="return false;"
            class="M_butt" target="_self"
        ><img title="<?php echo $strHelp; ?>" src="pmd/images/help.png" alt=""
        /></a> -->
        <img class="M_bord" src="pmd/images/bord.png" alt=""
